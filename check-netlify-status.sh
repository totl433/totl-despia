...
echo ""
echo "7. IMPORTANT:"
echo "   - Never deploy this mobile branch to Netlify."
echo "   - playtotl.com is deployed only from the web repository's main branch."
echo "   - TestFlight builds use EAS only: cd apps/mobile && eas build --platform ios --profile production --auto-submit"
echo ""
