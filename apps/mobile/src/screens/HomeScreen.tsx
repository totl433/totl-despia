...
export default function HomeScreen() {
  ...
  const fixturesByDate = React.useMemo(() => buildFixturesByDate(fixtures), [fixtures]);
  ...
  const stackFixtures = React.useMemo(() => sortFixturesByFixtureIndex(fixtures), [fixtures]);
