...
export default function RulesButton({ onClick, className ="" }: RulesButtonProps) {
 ...
 <button
 onClick={onClick}
 className={`flex items-center justify-center gap-1.5 bg-white border-2 border-slate-300 rounded-full text-slate-600 cursor-help flex-shrink-0 px-3 py-2 ${className}`}
 >
 <img 
