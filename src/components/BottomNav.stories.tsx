...
// Version with text labels under icons
    ...
    return (
      <>
        ...
        <div className="bottom-nav-absolute flex items-center justify-center px-4 pb-8">
          <div className="bg-[#1C8376] border border-[#178f72] rounded-full shadow-2xl flex items-center max-w-md w-full px-2 py-3 mb-4 relative" style={{ boxShadow: '0 15px 35px -5px rgba(0, 0, 0, 0.5), 0 10px 15px -5px rgba(0, 0, 0, 0.4)' }}>
            {navItems.map((item) => {
