...
/**
 * Desktop Navigation - horizontal top menu bar for desktop (1024px+)
 * Similar to BBC website style with logo on left and nav items horizontal
 */
export default function DesktopNav() {
  ...
  // All nav items including How To Play and Profile
  const allNavItems = [
  ...
  return (
    <nav className="bg-white border-b border-slate-200 sticky top-0 z-50">
      <div className="max-w-[1024px] mx-auto px-6 flex items-center justify-between h-20">
        {/* Logo on the left */}
        ...
        <div className="flex items-center gap-1 flex-1 justify-center">
          {allNavItems.map((item) => {
            const isActive = 'matchPaths' in item && item.matchPaths
              ? location.pathname === item.path || item.matchPaths.some((path: string) => location.pathname.startsWith(path))
            ...
            return (
              <Link
                ...
                className={`px-4 py-2 text-sm font-bold transition-colors relative ${
                  isActive
                    ? 'text-slate-900 after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-3/4 after:h-0.5 after:bg-slate-900'
                    : 'text-slate-700 hover:text-slate-900 hover:after:absolute hover:after:bottom-0 hover:after:left-1/2 hover:after:-translate-x-1/2 hover:after:w-3/4 hover:after:h-0.5 hover:after:bg-slate-300'
                }`}
              >
                {item.name}
              </Link>
            ...
            <Link
              ...
              className={`px-4 py-2 text-sm font-bold transition-colors relative ${
                location.pathname === '/admin'
                  ...
                  : 'text-red-600 hover:text-red-700 hover:after:absolute hover:after:bottom-0 hover:after:left-1/2 hover:after:-translate-x-1/2 hover:after:w-3/4 hover:after:h-0.5 hover:after:bg-red-300'
              }`}
            >
              <span>Admin</span>
            </Link>
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          <button
            ...
            className="px-4 py-2 text-sm font-medium text-red-600 hover:bg-red-50 transition-colors rounded-md"
          >
            Sign Out
          </button>
        </div>
