...
export default function ShareSheet({
 ...
 <button
 onClick={onClose}
 className="p-2 rounded-full active:bg-slate-300"
 aria-label="Close"
 >
 ...
 <button
 onClick={handleShare}
 className="w-full bg-[#1C8376] text-white font-semibold py-3 px-6 rounded-xl active:bg-emerald-800 touch-manipulation flex items-center justify-center gap-2"
 style={{ 
