...
export default function ShareSheet({
  ...
  // Handle WhatsApp share - use Web Share API (works in Despia like mini league share)
  const handleWhatsAppShare = async () => {
    try {
      // Use Web Share API (same approach as mini league share that works in Despia)
      if ((navigator as any).share) {
        try {
          // First try with image file
        ...
        // Fallback: text-only share (like mini league)
        try {
          await (navigator as any).share({
            title: `TOTL Gameweek ${gw} - ${userName}`,
            text: `Check out my Gameweek ${gw} predictions!`,
  ...
  const handleWebShare = async () => {
    try {
      ...
      // Fallback: Try Web Share API with text only (no file)
      if ((navigator as any).share) {
        try {
          await (navigator as any).share({
            title: `TOTL Gameweek ${gw} - ${userName}`,
        ...
        <div className="px-4 pb-8" style={{ paddingBottom: 'calc(2rem + env(safe-area-inset-bottom, 0px))' }}>
          ...
          <div className="grid grid-cols-5 gap-3">
            ...
            <button
              ...
              className="flex flex-col items-center gap-2 p-2 rounded-xl hover:bg-slate-50 active:bg-slate-100 transition-colors touch-manipulation"
            ...
            >
              ...
              <span className="text-xs text-slate-600 font-medium" style={{ lineHeight: '1.2', whiteSpace: 'nowrap' }}>WhatsApp</span>
            </button>
            ...
            >
              ...
              <span className="text-xs text-slate-600 font-medium" style={{ lineHeight: '1.2', whiteSpace: 'nowrap' }}>Message</span>
            </button>
            ...
            >
              ...
              <span className="text-xs text-slate-600 font-medium" style={{ lineHeight: '1.2', whiteSpace: 'nowrap' }}>Instagram</span>
            </button>
            ...
            >
              ...
              <span className="text-xs text-slate-600 font-medium" style={{ lineHeight: '1.2', whiteSpace: 'nowrap' }}>Copy</span>
            </button>
            ...
            >
              ...
              <span className="text-xs text-slate-600 font-medium" style={{ lineHeight: '1.2', whiteSpace: 'nowrap' }}>More</span>
            </button>
          </div>
        </div>
      </div>
