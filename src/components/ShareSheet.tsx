        ...
        <div className="px-4 pb-8" style={{ paddingBottom: 'calc(2rem + env(safe-area-inset-bottom, 0px))' }}>
          ...
          <div className="grid grid-cols-5 gap-3">
            ...
            <button
              ...
              className="flex flex-col items-center gap-1.5 p-2 rounded-xl hover:bg-slate-50 active:bg-slate-100 transition-colors touch-manipulation"
              style={{ minHeight: '90px', WebkitTapHighlightColor: 'transparent', paddingTop: '12px', paddingBottom: '12px' }}
            ...
            >
              ...
              <span className="text-xs text-slate-600 font-medium text-center" style={{ lineHeight: '1.3', whiteSpace: 'nowrap', marginTop: '4px' }}>WhatsApp</span>
            </button>
            ...
            >
              ...
              <span className="text-xs text-slate-600 font-medium text-center" style={{ lineHeight: '1.3', whiteSpace: 'nowrap', marginTop: '4px' }}>Message</span>
            </button>
            ...
            >
              ...
              <span className="text-xs text-slate-600 font-medium text-center" style={{ lineHeight: '1.3', whiteSpace: 'nowrap', marginTop: '4px' }}>Instagram</span>
            </button>
            ...
            >
              ...
              <span className="text-xs text-slate-600 font-medium text-center" style={{ lineHeight: '1.3', whiteSpace: 'nowrap', marginTop: '4px' }}>Copy</span>
            </button>
            ...
            >
              ...
              <span className="text-xs text-slate-600 font-medium text-center" style={{ lineHeight: '1.3', whiteSpace: 'nowrap', marginTop: '4px' }}>More</span>
            </button>
          </div>
        </div>
      </div>
