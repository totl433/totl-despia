...
export default function ShareSheet({
  ...
  const handleWhatsAppShare = async (e: React.MouseEvent) => {
    ...
    try {
      ...
      // Use Web Share API with image file - WhatsApp will appear in share sheet with image included
  ...
  const handleMessagesShare = async (e: React.MouseEvent) => {
    ...
    try {
      ...
      // Use Web Share API with image file - Messages will appear in share sheet with image included
      const nav = navigator as Navigator & { 
        share?: (data: ShareData) => Promise<void>;
        canShare?: (data: { files?: File[] }) => boolean;
      };
