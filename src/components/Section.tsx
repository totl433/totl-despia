...
export default function Section({
 ...
 className="w-full px-6 py-4 text-left bg-gradient-to-r from-slate-50 to-slate-100 border-b border-slate-200"
 >
 ...
 <div 
              className={`w-4 h-4 rounded-full border border-slate-400 flex items-center justify-center ${infoTitle && infoDescription ?'cursor-pointer' :''}`}
