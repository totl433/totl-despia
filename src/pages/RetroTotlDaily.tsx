          ...
          {phase === 'intro' ? (
            <div className="flex w-full flex-col items-center gap-2.5">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center rounded-full border-[1.5px] border-[#1C8376] bg-[#1C8376]/25 px-5 py-3 text-sm font-extrabold text-white hover:bg-[#1C8376]/40"
              >
                The Players
              </Link>
            </div>
