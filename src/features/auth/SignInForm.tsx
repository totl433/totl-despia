...
export default function SignInForm({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white px-6 pt-5">
      <h1 className="text-[40px] font-normal text-[#1C8376] leading-[1.2] tracking-tight mt-12 mb-10">Sign in</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          className="w-full py-3 bg-[#1C8376] text-white font-semibold rounded-full hover:bg-[#166b60] transition-colors"
        >
          Sign in
        </button>
      </form>
      ...
      <div className="mt-6 text-center space-y-2">
        <p className="text-sm text-slate-500">
          ...
          <button 
            ...
            className="text-[#1C8376] hover:underline"
          >
            Reset
          </button>
        </p>
