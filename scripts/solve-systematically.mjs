...
async function solveSystematically() {
  console.log('Solving systematically for exact results...\n');
  ...
  // Calculate what the current total scores are
  ...
  // We'll work gameweek by gameweek, trying to reduce scores appropriately
...
solveSystematically().catch(console.error);
