-- ============================================================================
-- Migration: Add Sim to app-only users list
-- ============================================================================
-- This updates the mirroring triggers to include Sim (c94f9804-ba11-4cd2-8892-49657aa6412c)
-- as one of the app-only users whose picks and submissions are automatically mirrored to web
-- ============================================================================

-- Update mirror_picks_to_web() function to include Sim
...
-- Update mirror_submissions_to_web() function to include Sim
