-- ============================================================================
-- Migration: Add Will Middleton to app-only users list
-- ============================================================================
-- This updates the mirroring triggers to include Will Middleton (42b48136-040e-42a3-9b0a-dc9550dd1cae)
-- as one of the app-only users whose picks and submissions are automatically mirrored to web
-- ============================================================================

-- Update mirror_picks_to_web() function to include Will Middleton
...
-- Update mirror_submissions_to_web() function to include Will Middleton
